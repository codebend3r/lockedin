-- 010_seed_java.sql
-- Java modules: split into three difficulty levels (24 / 56 / 20 questions). Module rows are in 006_seed_more_modules.sql.

-- ============================================================
-- java-1
-- ============================================================

-- Question 0 [orig 0] (primitive vs reference types) ----------------------------------
with q as (
  ...
  select id, null,
         ...
         0
  from modules where slug = 'java-1'
  returning id
)
...
-- Question 1 [orig 1] (default values for primitives) ---------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 2 [orig 8] (widening conversion) -------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 3 [orig 10] (String immutability) ------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 4 [orig 11] (StringBuilder vs String concatenation) ------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 5 [orig 15] (String.equals case sensitivity) ------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 6 [orig 17] (String.format) ------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 7 [orig 18] (text blocks) --------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 8 [orig 19] (chars vs Strings) ---------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 9 [orig 20] (constructor chaining with this) -------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 10 [orig 21] (super in constructor) -----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 11 [orig 22] (static fields) ------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 12 [orig 25] (final on a class) ---------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 13 [orig 26] (final on a method) --------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 14 [orig 27] (constructors and inheritance) ---------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 15 [orig 29] (this in static method) ----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 16 [orig 30] (interface vs abstract class) ----------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 17 [orig 34] (Object methods) -----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 18 [orig 40] (generic class declaration) ------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 19 [orig 50] (List vs Set) --------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 20 [orig 51] (ArrayList vs LinkedList random access) ------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 21 [orig 68] (NumberFormatException) ----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 22 [orig 70] (Runnable signature) -------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 23 [orig 95] (JVM memory regions) -------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
with q as (
  ...
  select id, null,
         ...
         0
  from modules where slug = 'java-2'
  returning id
)
insert into question_choices (question_id, label, is_correct, order_index)
select q.id, c.label, c.is_correct, c.order_index
...
-- Question 1 [orig 3] (== vs equals on Strings) ---------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 2 [orig 4] (Integer cache) -------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 3 [orig 5] (NullPointerException on unboxing) ------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 4 [orig 6] (pass-by-value) -------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 5 [orig 7] (equals + hashCode contract) ------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 7 [orig 12] (StringBuilder vs StringBuffer) --------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 8 [orig 13] (string pool / interning) --------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 9 [orig 14] (string literals interned) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 10 [orig 16] (String length unit) -------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 11 [orig 23] (package-private access) ---------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 12 [orig 24] (protected access) ---------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 13 [orig 28] (static method shadowing) --------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 14 [orig 31] (default methods) ----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 15 [orig 32] (diamond inheritance with defaults) ----------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 16 [orig 33] (interface state) ----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 17 [orig 35] (abstract method rules) ----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 18 [orig 36] (Liskov / overriding return type) ------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 19 [orig 37] (instanceof null) ----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 20 [orig 38] (abstract class with no abstract methods) ----------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 21 [orig 39] (interface static methods) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 22 [orig 41] (bounded type parameter) ---------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 23 [orig 45] (generic primitive restriction) --------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 25 [orig 47] (generic method syntax) ----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 26 [orig 52] (HashMap requirement) ------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 27 [orig 53] (HashMap null keys) --------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 28 [orig 54] (TreeMap ordering) ---------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 29 [orig 55] (LinkedHashMap order) ------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 30 [orig 56] (Iterator.remove vs collection.remove during iteration) --------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 31 [orig 57] (Collections.unmodifiableList) ---------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 32 [orig 59] (Set implementations) ------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 33 [orig 60] (checked vs unchecked) -----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 34 [orig 61] (finally always runs) ------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 35 [orig 62] (try-with-resources) -------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 36 [orig 63] (multi-catch) --------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 37 [orig 64] (throws clause and overrides) ----------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 38 [orig 65] (return in finally) --------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 39 [orig 67] (Error vs Exception) -------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 40 [orig 69] (custom checked exception) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 41 [orig 71] (Callable vs Runnable) -----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 42 [orig 72] (synchronized method) ------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 43 [orig 74] (Thread.start vs run) ------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 44 [orig 75] (ExecutorService shutdown) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 45 [orig 76] (Future.get blocking) ------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 46 [orig 80] (lambda target type) -------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 47 [orig 81] (Stream laziness) ----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 48 [orig 82] (Stream reuse) -------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 49 [orig 83] (Stream.collect grouping) --------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 50 [orig 84] (method references) --------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 51 [orig 85] (Optional purpose) ---------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 52 [orig 86] (Optional.orElseGet) -------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 53 [orig 87] (functional interface @ annotation) ----------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 54 [orig 89] (effectively final) --------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 55 [orig 92] (var keyword) --------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
with q as (
  ...
  select id, null,
         ...
         0
  from modules where slug = 'java-3'
  returning id
)
insert into question_choices (question_id, label, is_correct, order_index)
select q.id, c.label, c.is_correct, c.order_index
...
-- Question 1 [orig 43] (PECS consumer) ------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 2 [orig 44] (type erasure) -------------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 3 [orig 48] (multiple bounds) ----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 4 [orig 49] (unbounded wildcard) -------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 5 [orig 58] (HashMap initial capacity / load factor) ----------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 6 [orig 66] (suppressed exceptions) ----------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 7 [orig 73] (volatile semantics) -------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 8 [orig 77] (atomic vs synchronized) ---------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 9 [orig 78] (deadlock cause) -----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 10 [orig 79] (Thread.interrupt semantics) -----------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 11 [orig 88] (Stream.parallel) ----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 13 [orig 91] (sealed classes) -----------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 14 [orig 93] (switch expressions) -------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 15 [orig 94] (pattern matching for instanceof) ------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 16 [orig 96] (garbage collection roots) -------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 17 [orig 97] (finalize deprecated) ------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 18 [orig 98] (PermGen / Metaspace) ------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
...
-- Question 19 [orig 99] (modern GC default) --------------------------------------------
with q as (
  insert into questions (
    module_id, category, prompt, explanation,
    flashcard_back, recap_answer, order_index
